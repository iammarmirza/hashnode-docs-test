...
slug: managing-members-in-your-team
visibility: PUBLIC
...
> 📘 For Enterprise Server, If you have [Automatic Sync with GitHub](/docs/access-control-managing-members-in-your-team#automatic-sync-with-github) enabled and [SCIM](/docs/integrations-sso#setup-scim-provisioning) disabled, users are automatically added as members on DeepSource teams for their corresponding GitHub organizations.
...
> 📘 If you have [Automatic Sync with GitHub](#automatic-sync-with-github) enabled and [SCIM](/docs/integrations-sso#setup-scim-provisioning) disabled, removing a member from your GitHub organization removes them from the corresponding team on DeepSource as well.
...
![Image](https://files.readme.io/87408e6-SCR-20231017-lptm.png,,)[/block]


![Image](https://files.readme.io/2ba7bdd-SCR-20231017-lqae.png,,)[/block]
