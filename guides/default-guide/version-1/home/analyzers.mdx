...
| Docker        | GA      | `docker`        | NA               |
| Go            | GA      | `go`            | Available        |
| Rust          | GA      | `rust`          | Available        |
| Java          | GA      | `java`          | Available        |
| Scala         | GA      | `scala`         | NA               |
| C#            | GA      | `csharp`        | Available        |
| JavaScript    | GA      | `javascript`    | Available        |
| PHP           | GA      | `php`           | Available        |
| Python        | GA      | `python`        | Available        |
| Ruby          | GA      | `ruby`          | Available        |
| Secrets       | GA      | `secrets`       | NA               |
| Shell         | GA      | `shell`         | NA               |
| SQL           | GA      | `sql`           | NA               |
| C & C++       | Beta    | `cxx`           | NA               |
| Terraform     | GA      | `terraform`     | NA               |
| Test Coverage | GA      | `test-coverage` | NA               |
| Swift         | Beta    | `swift`         | Available        |
| Kotlin        | Beta    | `kotlin`        | Available        |
