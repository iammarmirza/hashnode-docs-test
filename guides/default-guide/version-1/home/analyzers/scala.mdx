...
This section covers configuration specific to the `scala` analyzer. Please make sure you read the general [configuration guide](https://deepsource-docs.readme.io/docs/configuration) first.
