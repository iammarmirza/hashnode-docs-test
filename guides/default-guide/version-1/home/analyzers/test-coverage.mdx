...
```bash
curl [https://deepsource.io/cli](https://deepsource.io/cli) | sh
```
...
Please refer 'report' command of [CLI documentation](https://docs.deepsource.com/docs/cli#commands) if you want to read more on the command usage.
...
# Or, use [https://github.com/linux-test-project/lcov/releases](https://github.com/linux-test-project/lcov/releases)
...
Please refer to [this section](https://docs.deepsource.com/docs/analyzers-test-coverage#installing-deepsource-cli-in-your-ci-enviroment) to learn more about the CLI's `report` command used in the examples.
...
2. Add the following script in the pipeline(s) running tests for the repository:
   ...
   - script: |
     # Install deepsource CLI
     curl -sSL [https://deepsource.io/cli](https://deepsource.io/cli) | sh
