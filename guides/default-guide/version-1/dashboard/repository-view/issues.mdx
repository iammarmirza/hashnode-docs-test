...
- You can ignore a particular occurrence of an issue if you think that is intentional. To permanently silence an issue, you can use `skipcq` rule, read more about it [here](https://docs.deepsource.com/docs/issues-ignore-rules).
