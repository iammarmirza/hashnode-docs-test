...
3. Your repository will now be onboarded as a monorepo, and you can proceed to [add sub-repositories](https://docs.deepsource.com/docs/repository-view-monorepos#activating-analysis-on-sub-repositories).
...
![](https://files.readme.io/f1558fe-modal-2.png)

![](https://files.readme.io/5f8626a-define_path.png)
