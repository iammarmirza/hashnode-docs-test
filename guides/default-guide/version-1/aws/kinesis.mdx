---
description: Ingest data from Firehose streams into Parseable
...
In the next screen, you can choose from various sources like [Kinesis data stream](https://aws.amazon.com/kinesis/data-streams/), [Amazon MSK (Kafka)](https://aws.amazon.com/msk/), and Direct PUT (i.e. send data directly to Firehose stream from an application).

<p align="center">
  <img src="https://parseable.com/aws/create_stream.png"/>
</p>
...
<p align="center">
  <img src="https://parseable.com/aws/destination_setting.png"/>
</p>
...
<p align="center">
  <img src="https://parseable.com/aws/backup_settings.png"/>
</p>
