...
description: Learn how to set up OpenTelemetry Collector to ship logs to Parseable in opentelemetry log format
...
<p align="center">
  <img src="/img/otel-collector.svg" alt="Parseable OTEL collector design" />
</p>
