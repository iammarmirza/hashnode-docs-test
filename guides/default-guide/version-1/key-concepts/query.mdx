---
title: Query
description: Discover Parseable's key concepts for querying log data. Explore the best practices for efficient log data management.
slug: query
visibility: PUBLIC
label: Query
---
...
<head>
<title>Parseable Query Concepts | Parseable</title>
<meta charSet="utf-8" />
