      ...
      pages: [
        ...
        { type: "page", path: "./developers/webhooks.mdx", pages: [] },
        {
          ...
          pages: [
            {
              type: "page",
              path: "./developer/api/personal-access-token.mdx",
              pages: [],
            },
            { type: "page", path: "./developer/api/viewer.mdx", pages: [] },
            { type: "page", path: "./developer/api/account.mdx", pages: [] },
            { type: "page", path: "./developer/api/team.mdx", pages: [] },
            { type: "page", path: "./developer/api/repository.mdx", pages: [] },
            { type: "page", path: "./developer/api/check.mdx", pages: [] },
            { type: "page", path: "./developer/api/analysis-run.mdx", pages: [] },
            { type: "page", path: "./developer/api/analyzer.mdx", pages: [] },
            { type: "page", path: "./developer/api/transformer.mdx", pages: [] },
            { type: "page", path: "./developer/api/issue.mdx", pages: [] },
            { type: "page", path: "./developer/api/metric.mdx", pages: [] },
            { type: "page", path: "./developer/api/reference-enums.mdx", pages: [] },
            { type: "page", path: "./developer/api/reference-scalars.mdx", pages: [] },
            {
              type: "page",
              path: "./developer/api/reference-pagination.mdx",
              pages: [],
            },
            { type: "page", path: "./developer/api/reports.mdx", pages: [] },
          ],
        },
      ],
    },
