---
description: Send Azure API Management Service Logs to Parseable
title: API Management Service Logs
slug: apim
visibility: PUBLIC
label: API Management Service Logs
---
...
- Active Azure subscription with APIM service created. Refer the [Azure API Management](https://docs.microsoft.com/en-us/azure/api-management/) documentation for more information.
- Azure Event Hub created. Refer the [Create an event hub using Azure portal](https://docs.microsoft.com/en-us/azure/event-hubs/event-hubs-create) documentation for more information.

### Send Azure APIM Service Logs to Event Hub

1. Navigate to the Azure API Management Service in the Azure portal.
2. Click on the `Diagnostics settings` under the `Monitoring` section.
3. Configure the APIM service to send logs to the Event Hub. Refer the image below for more information.

<p align="center">
  <img src="https://parseable.com/azure/apim_diagnostics_settings.png"/>
</p>
...
3. Configure the Logic App to trigger when an event is received in the Event Hub. Refer the image below for more information. We have used the `When  events are available in Event Hub` trigger to start the Logic App.

<p align="center">
  <img src="https://parseable.com/azure/azure_logic_apps_parseable.png"/>
</p>
