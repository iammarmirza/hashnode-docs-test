...
- [GitHub](https://docs.deepsource.com/docs/gh)
- [GitLab](https://docs.deepsource.com/docs/gitlab)
- [Bitbucket Cloud](https://docs.deepsource.com/docs/bitbucket-cloud)
- [Google Source Repositories](https://docs.deepsource.com/docs/google-source-repositories)
...
**Enable SAML SSO:** Configure SAML SSO for your application. A guide to integrating your SSO provider is available in the [SSO](https://docs.deepsource.com/docs/integrations-sso) section of the docs.

**Deploy embedded database:** The application will automatically provision an embedded database within the cluster when enabled. This is often recommended for pilot installations and is not recommended in production. A detailed guide on setting up an external database is available [here](https://docs.deepsource.com/docs/enterprise-server-configuration#configuring-your-app-to-use-the-external-database).
...
**Upload TLS certificate and private key?:** This option is used to configure the TLS settings. A detailed guide on setting up TLS is available [here](https://docs.deepsource.com/docs/enterprise-server-configuration#setup-tls).
...
This section would be visible if you are using the [Standalone installation](https://docs.deepsource.com/docs/installation-standalone-cluster) method.  The cluster management section provides information about the nodes in your cluster.  The cluster management portal allows you to:
...
1. Log into the [Admin Console](https://docs.deepsource.com/docs/enterprise-server-configuration#admin-console).
...
- Create a backup using the [pg_dump](https://www.postgresql.org/docs/current/app-pgdump.html) utility.
  ```shell SH
...
- You can use [pg_restore](https://www.postgresql.org/docs/current/app-pgrestore.html) to apply the dump to your new database.
