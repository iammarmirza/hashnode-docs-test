...
```bash
python3 <(curl -s [https://raw.githubusercontent.com/DeepSourceCorp/enterprise-assets/master/integrations/create_slack_app.py)](https://raw.githubusercontent.com/DeepSourceCorp/enterprise-assets/master/integrations/create_slack_app.py))
```
...
1. Visit the [Admin Console](https://docs.deepsource.com/docs/enterprise-server-configuration#admin-console)
