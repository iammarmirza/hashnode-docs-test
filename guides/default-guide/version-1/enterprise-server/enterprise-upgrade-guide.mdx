...
4. Check for updates from Admin console and edit the config for DeepSource Enterprise Server (v3.31.0) with new password, select auth_type as `sha-scram-256` and save the config.
   ...
   1. Select "Configure" for the latest version with status "pending config"
      ...
      ![Image](https://files.readme.io/a2dd9107ad052902fc9a5ce0df593b15ac16cb786c71a7562b5f42d0f8b4e7ed-SCR-20241004-mtvt.png,,)[/block]
   2. Select "scram-sha-256" as Database Authentication Type under **Database Configuration**

      ![Image](https://files.readme.io/16ba370e4aaa7004507916ad8331965295c072275527e652580756fe3806e07c-isfLVCbnl1ymxGlDMDeQWac5.png,,)[/block]
   3. Update the password field with the newly generated password

      ![Image](https://files.readme.io/53d8ab2396b0d9dcbdcc761b8b34cb9502bd2c8c5eeed275c7a93e41ccc844f1-ulCQtfQQdTdsHTTtvst-T9ww.png,,)[/block]
   4. Save config

      ![Image](https://files.readme.io/bfb3fc44493d2df02ceca9a3fd386b0d33c2b4bd6c3805a95ad8c093a9b8e1c6-ou5l7DDZkg-F7jsQRmFLsXs7.png,,)[/block]
