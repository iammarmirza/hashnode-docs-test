...
To update the App Manager, refer to [https://docs.replicated.com/enterprise/updating-app-manager#air-gap-environments](https://docs.replicated.com/enterprise/updating-app-manager#air-gap-environments).
