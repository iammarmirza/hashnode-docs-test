...
> If you haven't received the email with your download portal and password, reach out to [enterprise-support@deepsource.io](mailto:enterprise-support@deepsource.io)
...
```
curl -LO [https://github.com/replicatedhq/kots/releases/latest/download/kots_darwin_all.tar.gz](https://github.com/replicatedhq/kots/releases/latest/download/kots_darwin_all.tar.gz)
```

**Linux (AMD)**:

```
curl -LO [https://github.com/replicatedhq/kots/releases/latest/download/kots_linux_amd64.tar.gz](https://github.com/replicatedhq/kots/releases/latest/download/kots_linux_amd64.tar.gz)
```

**Linux (ARM)**:

```
curl -LO [https://github.com/replicatedhq/kots/releases/latest/download/kots_linux_arm64.tar.gz](https://github.com/replicatedhq/kots/releases/latest/download/kots_linux_arm64.tar.gz)
```
...
Visit [https://docs.deepsource.com/docs/enterprise-server-configuration](https://docs.deepsource.com/docs/enterprise-server-configuration) to configure the app from admin console.
