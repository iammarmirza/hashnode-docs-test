...
> 
> DeepSource Enterprise Server AMIs provided are created for single node setup with no High Availability (HA), for information on installing DeepSource Enterprise with HA visit [this link](#)
...
> For more info on AWS IAM policies and users, visit [AWS IAM User Guide](https://docs.aws.amazon.com/IAM/latest/UserGuide/access.html).
