...
3. Create an external database using the following guide: [Enterprise Server Configuration](https://docs.deepsource.com/docs/enterprise-server-configuration#bring-your-own-database). You can skip this step for pilot installation.
...
1. Make sure `yq` is installed on your system. To install `yq`, follow the installation guide: [yq installation guide](https://mikefarah.gitbook.io/yq/v/v3.x/)
