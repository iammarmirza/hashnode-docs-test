...
- If your organization uses SSO, please refer to [these instructions](https://docs.deepsource.com/docs/integrations-sso) on setting up an Identity Provider for adding a user.
