...
slug: scim-provisioning-on-okta
visibility: PUBLIC
label: SCIM provisioning on Okta
---
## Introduction
...
> 📘 To learn more about how groups help you manage your DeepSource Enterprise installation better, please refer to our [User management documentation](https://docs.deepsource.com/docs/user-management).

## How to setup SCIM

In order to take benefit from SCIM, there is [an initial setup](https://docs.deepsource.com/docs/saml-sso-scim-okta#scim-provisioning) that has to be performed before moving ahead with the steps on this page.
...
> 📘 The users from the assigned group will be immediately synced with your DeepSource Enterprise installation. But, to sync the groups and their memberships to the DeepSource Enterprise installation, an additional step of [“Group push”](https://docs.deepsource.com/docs/scim-provisioning-on-okta#enable-group-push) is required.
...
- **How do I re-enable SCIM after I disabled it?**
  ...
  In order to re-enable SCIM, ensure the [initial setup](https://docs.deepsource.com/docs/saml-sso-scim-okta#scim-provisioning) is done and then perform a **[Push now](https://help.okta.com/en/prod/Content/Topics/users-groups-profiles/usgp-enable-group-push.htm#:~:text=Push%20Now%3A%20Select,are%20not%20overwritten.).** This will overwrite your DeepSource Enterprise installation groups with the data in Okta.
