...
| Redirect URI | [https://`HOSTNAME`/accounts/gitlab/login/callback/bifrost/](https://`HOSTNAME`/accounts/gitlab/login/callback/bifrost/) | `https://deepsource.stark.com/accounts/gitlab/login/callback/bifrost/` |
| Confidential | `true`                                                       |                                                                        |
