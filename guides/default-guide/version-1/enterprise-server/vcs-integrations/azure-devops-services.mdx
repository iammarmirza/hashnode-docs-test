...
| Application name | DeepSource `ORGANIZATION_NAME` | DeepSource Stark International |
| Application website | https\://`HOSTNAME` | `https://deepsource.stark.com/` |
| Authorization callback URL | https\://`HOSTNAME`/accounts/ads/login/callback/bifrost | `https://deepsource.stark.com/accounts/ads/login/callback/bifrost/` |
...
[https://files.readme.io/6164eea-image.png](https://files.readme.io/6164eea-image.png)
