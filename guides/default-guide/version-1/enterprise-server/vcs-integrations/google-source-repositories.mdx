...
slug: google-source-repositories
visibility: PUBLIC
...
3. Go to APIs and Services/Google Cloud Credentials:
   ...
   4. Under the heading "Authorized Redirect URIs", add \<https://deepsource.company.com/accounts/google/login/callback/bifrost/\> (Replace deepsource.company.com with the URL at which deepsource is deployed).
...
2. Go to [https://source.cloud.google.com/user/ssh_keys?register=true](https://source.cloud.google.com/user/ssh_keys?register=true). It might ask you for a password:
