---
title: AWS EKS
description: Unlock the power of IAM Roles for Service Accounts (IRSA) with our comprehensive setup guide. Secure and manage access seamlessly. Get started now!
slug: setup-iam-roles-for-service-accounts
visibility: PUBLIC
label: AWS EKS
---

<head>
<title>How to Setup IAM Roles for Service Accounts (IRSA)? | Parseable</title>
<meta charSet="utf-8" />
<meta name="twitter:card" content="summary" />
</head>

This page explains additional EKS specific features and configuration options for Parseable. For general Parseable installation instructions, see [installation documentation](https://www.parseable.com/docs/category/installation).
...
Refer to the AWS docs: https://docs.aws.amazon.com/eks/latest/userguide/enable-iam-roles-for-service-accounts.html

### Create an IAM Policy

Parseable requires the below permissions to run on S3. (replace `<bucket-name>` with your bucket name). Complete list of S3 actions is [available here](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Operations.html).
