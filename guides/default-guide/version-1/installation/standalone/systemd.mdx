---
title: Linux
description: Configure systemd service for Parseable server in S3 or local store mode. Simplify management and ensure reliable operation. Learn how now!
slug: setup-systemd-service-for-parseable-server
visibility: PUBLIC
label: Linux
---
