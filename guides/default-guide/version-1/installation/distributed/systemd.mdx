---
title: Linux
description: Configure systemd service for Parseable server in S3 mode. Simplify management and ensure reliable operation. Learn how now!
slug: setup-systemd-service-for-distributed-parseable-server
visibility: PUBLIC
label: Linux
---

<head>
<title>How to Setup Systemd Service for Parseable Server? | Parseable</title>
<meta charSet="utf-8" />
...
You can now access Parseable at the address [http://localhost:8000](http://localhost:8000) (default configuration). If you added `P_ADDR` in config file, please access the correct URL accordingly.
...
You can now access Parseable at the address [http://localhost:8000](http://localhost:8000) (default configuration). If you added `P_ADDR` to the config file, please access the correct URL accordingly.
