---
title: Telemetry
description: Parseable Telemetry - Parseable collects anonymized usage statistics from users in order to improve the server.
slug: telemetry
visibility: PUBLIC
label: Telemetry
---
...
<head>
<title>Parseable Telemetry | Parseable</title>
<meta charSet="utf-8" />
...
Any data that has already been collected can be [deleted on request](mailto:hi@parseable.com).
...
To request data deletion, send an email to hi@parseable.com containing the unique `Deployment UID` generated for your Parseable installation.
