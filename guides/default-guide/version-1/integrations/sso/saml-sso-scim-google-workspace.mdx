...
1. Navigate to https://admin.google.com/ac/apps/unified.
2. On the menu bar, click on **"Add App" -> "Add custom SAML app"**.

![Image](https://files.readme.io/d338028-image.png,,)[/block]


3. Fill in the following details:

![Image](https://files.readme.io/9497133-image.png,,)[/block]
...
![Image](https://files.readme.io/9e0fc91-image.png,,)[/block]
...
![Image](https://files.readme.io/13a8d65-image.png,,)[/block]


![Image](https://files.readme.io/daaedcd-image.png,,)[/block]


7. The file downloaded in the previous step should be hosted on a publicly accessible URL. You can either host it on your own infrastructure or an easy alternative is to paste it into a public gist on https://gist.github.com.
