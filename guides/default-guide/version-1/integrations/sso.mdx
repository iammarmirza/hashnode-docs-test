...
1. [Okta](/docs/sso-saml-sso-scim-okta)
2. [OneLogin](/docs/sso-saml-sso-scim-onelogin)
3. [Azure AD](/docs/sso-saml-sso-scim-azure-ad)
4. [Google Workspace](/docs/saml-sso-scim-google-workspace)
...
1. Go to https://app.deepsource.com.
...
![Image](https://files.readme.io/a0fc5bd-small-scim-config-2.png,,)[/block]
