---
description: Ingest AWS Lambda logs to Parseable
title: Lambda Functions
slug: aws-lambda-extension
visibility: PUBLIC
...
Refer Parseable [installation documentation](https://www.parseable.com/docs/category/installation) for more details.
