...
description: Effortlessly configure Grafana data sources for comprehensive visualization. The plugin allows you to query and visualize log data stored in Parseable server, in your Grafana dashboard.
slug: grafana-data-source-configuration
visibility: PUBLIC
label: Grafana Data Source
---

<head>
<title>Grafana Data Source Configuration | Parseable</title>
<meta charSet="utf-8" />
...
- If you're provisioning Grafana using [config management tools like Ansible](https://grafana.com/docs/grafana/latest/administration/provisioning/#configuration-management-tools), you can manage data sources in Grafana by adding YAML configuration files in the `provisioning/datasources` directory. Refer [Grafana documentation](https://grafana.com/docs/grafana/latest/administration/provisioning/#data-sources) for more details.
...
![alert-name](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-name.png?raw=true)
3. Add a query that returns numerical values, as Grafana supports alerts only on numerical data.
![alert-query](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-query.png?raw=true)
4. Specify threshold behavior for the defined rule query.
![alert-condition](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-condition.png?raw=true)
5. Define the evaluation behavior (e.g., eval frequency, grouping).
![alert-eval](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-eval.png?raw=true)
6. Save the alert.
...
![alert-list](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-list.png?raw=true)
...
![alert-target](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-target.png?raw=true)
...
![alert-policy](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-policy.png?raw=true)
...
![alert-firing](https://github.com/parseablehq/.github/blob/main/images/grafana/alert-firing.png?raw=true)
...
Refer sample dashboard here: [Grafana Dashboard Demo](http://demo.parseable.com:3000/?orgId=1). Credentials (admin, admin123).
