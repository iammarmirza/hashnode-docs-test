...
2. Click on config → Manage Access to DeepSource → Enable beta features
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/66c4189-kots-settings.png","",""],"align":"center"}]}[/block]
...
4. Deploy the newly available version to apply the new configuration.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/f17502c-deploy.png","",""],"align":"center"}]}[/block]
...
> 
> [block:image]{"images":[{"image":["https://files.readme.io/4148aab-quick-fix.png","",""],"align":"center"}]}[/block]
