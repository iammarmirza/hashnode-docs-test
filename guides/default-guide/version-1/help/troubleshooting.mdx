...
If your repository has files that you don't want to run analysis on (like migrations, examples, fixtures, etc) please make sure they are specified in the [exclude_patterns](https://docs.deepsource.com/docs/configuration#exclude_patterns) in the `.deepsource.toml` config file.
...
Please report it to [support@deepsource.io](mailto:support@deepsource.io) with a screenshot or the code snippet for which the wrong Autofix was generated.
