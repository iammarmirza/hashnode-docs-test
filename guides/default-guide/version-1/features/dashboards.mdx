---
title: "Dashboards"
description: The new Dashboards feature in Parseable allows users to visualize data insights at a glance.
slug: dashboards
visibility: PUBLIC
label: Dashboards
---
...
<head>
<title>Parseable Dashboards: Transform Queries to Dashboard | Parseable</title>
<meta charSet="utf-8" />
...
<img src="https://github.com/parseablehq/.github/blob/main/images/dashboards-png-export.png/?raw=true" alt="dashboards" style={{ border: '0.5px solid #f1e8e8', borderRadius: '5px' }} />
