---
title: "Hot Tier"
description: Parseable Log Analytics offers tiering capabilities to help you manage your log data more efficiently. The Hot Tier is designed to store and analyze your most recent log data.
slug: hot-tier
visibility: PUBLIC
label: Hot Tier
---
...
<head>
<title>Parseable Hot Tier: Tiered storage for latest data for faster query | Parseable</title>
<meta charSet="utf-8" />
